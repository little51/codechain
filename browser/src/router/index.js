...
export const constantRoutes = [
  ...
  },
  {
    ...
    name: '/Blocks',
    meta: { title: 'Blockchain', icon: 'example' },
    children: [
      {
        path: 'blocks',
        name: 'blocks',
        component: () => import('@/views/blocks/index'),
        meta: { title: 'blocks', icon: 'table' }
      },
      {
        path: 'blockdetail/:block',
        name: 'blockdetail',
        component: () => import('@/views/blocks/blockdetail')
        // meta: { title: 'block-detail', icon: 'tree' }
      }
      // {
      //   path: 'tree',
      //   name: 'Tree',
      //   // component: () => import('@/views/tree/index'),
      //   component: () => import('@/views/blocks/mockTable'),
      //   meta: { title: 'block-detail', icon: 'tree' }
      // }
    ]
  },
  {
    ...
    component: Layout,
    name: 'Nodes',
    meta: { title: 'Nodes', icon: 'form' },
    children: [
      {
        path: 'nodes',
        name: 'nodes',
        component: () => import('@/views/nodes/index'),
        meta: { title: 'Full Nodes', icon: 'link' }
      },
      {
        path: 'node/:node',
        name: 'node',
